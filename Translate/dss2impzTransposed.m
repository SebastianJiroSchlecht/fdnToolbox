function impulseResponse = dss2impzTransposed(irLen, delays, A, B, C, D, varargin)
...
impulseResponse = processTransposedFDN(input, delays, A, B, C, D,'inputType','splitInput', varargin{:});
