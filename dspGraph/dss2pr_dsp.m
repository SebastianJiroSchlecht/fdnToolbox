function [residues, poles, direct, isConjugatePolePair, metaData] = dss2pr_dsp(F,B,C,D,varargin)
...
%% Find poles
[poles,quality, metaDataRefine] = refinePolePositions_dsp(poles, F,...
...
%% Compute residues
[residues,direct,undrivenResidues,eigenvectors] = dss2res_dsp(poles,F,B,C,D);
